...
- [~] Файли: New ✔ / Open ✔ / Save ✔ / Save As ✔, `.xlsx` ✔ / `.xlsm` ✔ (макроси verbatim — ніколи не розбираються, ніколи не виконуються, ніколи не гублються; банер каже про це спокійно, бо це не збій), `.bak` ✔ (atomic write через `write_document`). Нова книга несе мінімальний `styles.xml` — без нього тулбару нема куди класти вигляд, і у файл можна було б лише друкувати. Лишилось: `.csv`/`.ods` "Open with", autosave, crash recovery
