...
- [~] Панель стилів: застосування, створення власного, «оновити за виділенням», стилі символів (`w:rStyle`)
      — панель показує стилі абзацу й символів із самого документа й застосовує їх; `w:rStyle` тепер модель, а не втрата. Створення власного стилю й «оновити за виділенням» ще попереду
