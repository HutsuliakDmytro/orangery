...
- [~] Track changes: `w:ins` / `w:del` / `w:rPrChange`, панель прийняти/відхилити, режим запису виправлень
      — `w:ins` і `w:del` читаються, показуються й пишуться назад (текст видаленого йде як `w:delText`); прийняти/відхилити — на виділення або на весь документ. Лишилися `w:rPrChange` (зміни форматування) і режим запису власних виправлень
