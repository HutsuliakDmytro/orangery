...
- [x] RTF — import + export (базове форматування), списки й таблиці в обидва боки
      — читання не відновлює список як список: RTF позначає його номером у таблиці нумерації, яку ми пропускаємо, тож імпортований список лишається абзацами з відступом
